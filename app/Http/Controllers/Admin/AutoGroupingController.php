...
class AutoGroupingController extends Controller
{
    ...
    public function store(Request $request)
    {
        DB::beginTransaction();
        try {
            // Ensure clean start: Delete existing groups and group members in correct order
            // Start from tables with FKs to tables that will be truncated later
            ...
            MentoringGroup::truncate();
            PlacementTest::truncate(); // Truncate last
            
            dd('All Truncates Successful'); // Debugging point
            
            // The rest of the logic is commented out for now for debugging isolation
