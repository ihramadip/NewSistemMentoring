<x-app-layout>
    <x-slot name="header">
        <x-page-header title="{{ __('Edit Ujian') }}" subtitle="Perbarui detail ujian dan kelola pertanyaannya.">
            <x-slot name="icon">
                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.exams.update', $exam) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $exam->name)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <x-textarea-input id="description" name="description" class="mt-1 block w-full">{{ old('description', $exam->description) }}</x-textarea-input>
                        ...
                        <div class="mb-4">
                            ...
                            <x-select-input id="level_id" name="level_id" class="mt-1 block w-full">
                                ...
                                @foreach($levels as $level)
                                    <option value="{{ $level->id }}" {{ old('level_id', $exam->level_id) == $level->id ? 'selected' : '' }}>
                                        {{ $level->name }}
                                    </option>
                                @endforeach
                            </x-select-input>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="duration_minutes" name="duration_minutes" type="number" class="mt-1 block w-full" :value="old('duration_minutes', $exam->duration_minutes)" min="1" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="published_at" name="published_at" type="datetime-local" class="mt-1 block w-full" :value="old('published_at', $exam->published_at ? $exam->published_at->format('Y-m-d\TH:i') : '')" />
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-8">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-4 border-b pb-2">
                        <h3 class="text-xl font-bold text-gray-800">Manajemen Pertanyaan</h3>
