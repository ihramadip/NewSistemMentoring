<x-app-layout>
    <x-slot name="header">
        <x-page-header title="{{ __('Edit Pelatihan Mentor') }}">
            <x-slot name="icon">
                    ...
                    <form action="{{ route('mentor.trainings.update', $training) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="type" name="type" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="TFM" {{ old('type', $training->type) == 'TFM' ? 'selected' : '' }}>TFM (Training for Mentor)</option>
                                <option value="Diklat" {{ old('type', $training->type) == 'Diklat' ? 'selected' : '' }}>Diklat Pementor</option>
                            </select>
                        ...
                        <div>
                            ...
                            <x-textarea-input id="description" name="description" class="mt-1 block w-full">{{ old('description', $training->description) }}</x-textarea-input>
                        ...
                        <div>
                            ...
                            <x-text-input id="schedule_date" class="block mt-1 w-full" type="date" name="schedule_date" :value="old('schedule_date', $training->schedule_date->format('Y-m-d'))" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="schedule_time" class="block mt-1 w-full" type="text" name="schedule_time" :value="old('schedule_time', $training->schedule_time)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="material_link" class="block mt-1 w-full" type="url" name="material_link" :value="old('material_link', $training->material_link)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="test_link" class="block mt-1 w-full" type="url" name="test_link" :value="old('test_link', $training->test_link)" />
