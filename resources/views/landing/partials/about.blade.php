<section id="tentang" class="relative -mt-14 rounded-t-[40px] bg-white px-6 pb-24 pt-20 shadow-[0_-40px_120px_-60px_rgba(28,167,167,0.45)]">
    <div class="mx-auto max-w-6xl">
        <div class="flex flex-col gap-10 lg:flex-row lg:items-start">
            <div class="lg:w-1/2">
                <p class="text-sm font-semibold uppercase tracking-[0.6em] text-brand-teal">Tentang Organisasi</p>
                <h3 class="section-title font-heading text-4xl text-brand-ink">BOM-PAI hadir sebagai wajah resmi pembinaan mahasiswa Islami UNISBA.</h3>
                ...
                <div class="mt-6 grid gap-4">
                    <div class="rounded-2xl border border-brand-sky/40 p-5">
            ...
            <div class="lg:w-1/2">
                <div class="grid gap-4">
                    @foreach ([
                        ...
                        <div class="glass-panel rounded-3xl border border-brand-sky/45 px-6 py-5">
                            <p class="text-sm font-semibold text-brand-teal">{{ $item['title'] }}</p>
