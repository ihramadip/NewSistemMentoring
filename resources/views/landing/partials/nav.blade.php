    ...
    <div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        <div class="flex items-center gap-3">
            ...
            <div class="text-white">
                <p class="text-xs uppercase tracking-[0.4em] text-white/70">BOM-PAI UNISBA</p>
                <h1 class="font-heading text-lg font-semibold">Badan Operasional Mentoring PAI</h1>
            </div>
        </div>
        ...
        <a href="{{ route('login') }}" class="hidden rounded-full bg-brand-teal px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-brand-teal/30 transition hover:brightness-90 md:inline-block">
