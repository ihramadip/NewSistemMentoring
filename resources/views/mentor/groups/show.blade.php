            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="flex items-center justify-between">
                        <h2 class="text-xl font-semibold text-gray-800">Daftar Sesi</h2>
                        <x-primary-button href="{{ route('mentor.sessions.create-for-group', $group) }}">
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6 text-gray-900 text-center">
                                ...
                                <p class="mt-1 text-sm text-gray-600">
                                    Anda belum membuat sesi untuk kelompok ini. Klik tombol untuk membuat sesi pertama.
                                </p>
                            </div>
                        </div>
                    @endforelse
